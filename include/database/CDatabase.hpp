...
public:
	...
	virtual CDatabaseQueryResult executePreparedQuery(const std::string& queryName,
...
protected:
	...
	CDatabaseQueryResult processParameterizedQuery(const std::string& query, const std::vector<std::string>& params);
	...
	void cleanupState();
	std::string buildErrorMessage(const std::string& operation, const std::string& details);
