...
class CPostgresDatabase : public CDatabase
{
  public:
    ...
    bool exportData(const std::string& tableName,
                    const std::string& exportPath);
    bool importData(const std::string& tableName,
                    const std::string& importPath);
    bool createUser(const std::string& username, const std::string& password);
    bool dropUser(const std::string& username);
    bool grantPrivileges(const std::string& username,
                         const std::string& privileges);
    bool revokePrivileges(const std::string& username,
                          const std::string& privileges);
    void clearErrors();
