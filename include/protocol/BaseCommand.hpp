...
protected:
     ...
     */
    shared_ptr<CPostgresDatabase> getConnection(shared_ptr<CPGConnectionPooler> connectionPooler);
...
public:
    bool requiresConnection() const override { return true; }
};
