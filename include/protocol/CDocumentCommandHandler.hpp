								...
								public IDocumentCommandHandler
{
  public:
	...
	CCommandResult handleCommand(const std::string& commandName,
	...
	CCommandResult handleListCollections(const std::vector<uint8_t>& commandData);
  ...
  private:
	...
	std::vector<uint8_t> extractCommandArguments(const std::vector<uint8_t>& commandData);
	...
	CCommandResult buildAggregateResponse(const std::vector<uint8_t>& pipelineData);
