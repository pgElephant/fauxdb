...
bool CLibpq::connect(const std::string& host, const std::string& port,
...
bool CLibpq::connect(const std::string& connectionString)
{
    ...
    try
    {
        ...
        if (passwordPos != std::string::npos)
        {
            ...
            {
                debugString.replace(passwordPos, endPos - passwordPos,
                                    "password=***");
            }
            else
            {
                debugString.replace(passwordPos, std::string::npos,
                                    "password=***");
            }
        }
...
std::string CLibpq::buildConnectionString() const
{
    ...
    // timezone is set after connection using SET timezone, not in connection
    // string
