...
CCommandResult CCommandResult::createSuccess(const std::vector<uint8_t>& response)
{
	return CCommandResult(true, response);
}

CCommandResult CCommandResult::createError(const std::string& message, int32_t code)
{
	return CCommandResult(false, message, code);
}

CCommandResult CCommandResult::createError(int32_t code, const std::string& message)
{
	return CCommandResult(false, message, code);
}
...
CCommandResult CCommandHandler::routeCommand(const std::string& commandName,
