...
string CBuildInfoCommand::getCommandName() const
{
    return "buildInfo";
}

vector<uint8_t> CBuildInfoCommand::execute(const CommandContext& context)
{
    /* BuildInfo doesn't require database connection */
    return executeWithoutDatabase(context);
}

bool CBuildInfoCommand::requiresDatabase() const
{
...
CBsonType CBuildInfoCommand::createVersionInfo()
{
    CBsonType version;
    version.initialize();
...
CBsonType CBuildInfoCommand::createBuildEnvironment()
{
    CBsonType env;
    env.initialize();
    env.beginDocument();
...
CBsonType CBuildInfoCommand::createFeatureCompatibility()
{
    CBsonType compat;
    compat.initialize();
...
CBsonType CBuildInfoCommand::createModulesInfo()
{
    CBsonType modules;
    modules.initialize();
...
string CBuildInfoCommand::getBuildDate()
{
...
string CBuildInfoCommand::getGitVersion()
{
    /* Mock git version */
    return "fauxdb-v1.0.0-1234567890abcdef";
}

string CBuildInfoCommand::getCompilerVersion()
{
