...
string CHelloCommand::getCommandName() const
{
    return "hello";
}

vector<uint8_t> CHelloCommand::execute(const CommandContext& context)
{
    /* Hello doesn't require database connection */
    return executeWithoutDatabase(context);
}

bool CHelloCommand::requiresDatabase() const
{
...
CBsonType CHelloCommand::createTopologyInfo()
{
    CBsonType topology;
    topology.initialize();
...
CBsonType CHelloCommand::createReplicationInfo()
{
...
CBsonType CHelloCommand::createHostInfo()
{
    CBsonType host;
    host.initialize();
    host.beginDocument();
...
CBsonType CHelloCommand::createTimingInfo()
{
    CBsonType timing;
    timing.initialize();
...
string CHelloCommand::getServerHostname()
{
    char hostname[256];
...
int32_t CHelloCommand::getServerPort()
{
