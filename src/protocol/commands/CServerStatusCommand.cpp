...
string CServerStatusCommand::getCommandName() const
{
    return "serverStatus";
}

vector<uint8_t> CServerStatusCommand::execute(const CommandContext& context)
{
    /* serverStatus doesn't require database connection for basic info */
    return executeWithoutDatabase(context);
}

bool CServerStatusCommand::requiresDatabase() const
{
...
CBsonType CServerStatusCommand::createHostInfo()
{
    CBsonType host;
    host.initialize();
    host.beginDocument();
...
CBsonType CServerStatusCommand::createVersionInfo()
{
    CBsonType version;
    version.initialize();
...
CBsonType CServerStatusCommand::createProcessInfo()
{
    CBsonType process;
    process.initialize();
...
CBsonType CServerStatusCommand::createUptimeInfo()
{
    CBsonType uptime;
    uptime.initialize();
...
CBsonType CServerStatusCommand::createConnectionsInfo()
{
...
CBsonType CServerStatusCommand::createNetworkInfo()
{
    CBsonType network;
    network.initialize();
...
CBsonType CServerStatusCommand::createMemoryInfo()
{
    CBsonType memory;
    memory.initialize();
...
CBsonType CServerStatusCommand::createMetricsInfo()
{
    CBsonType metrics;
    metrics.initialize();
...
CBsonType CServerStatusCommand::createStorageEngineInfo()
{
