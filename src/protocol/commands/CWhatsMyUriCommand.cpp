...
string
CWhatsMyUriCommand::getCommandName() const
{
    return "whatsMyUri";
}
...
vector<uint8_t>
CWhatsMyUriCommand::execute(const CommandContext& context)
{
...
bool
CWhatsMyUriCommand::requiresDatabase() const
{
...
string
CWhatsMyUriCommand::getClientConnectionString()
{
...
string
CWhatsMyUriCommand::getServerHostname()
{
    char hostname[256];
...
int32_t
CWhatsMyUriCommand::getServerPort()
{
